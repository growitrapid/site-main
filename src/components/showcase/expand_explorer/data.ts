        ...
        items: [
            {
                ...
                description: 'Build a captivating online presence with a fully customized website.',
            },
            {
                title: 'E-commerce Development',
                description: 'Create a seamless online shopping experience that drives sales and conversions.',
            },
            {
                title: 'Responsive Design',
                description: 'Engage your audience on any device with websites optimized for mobile and desktop.',
            },
            {
        ...
        items: [
            {
                ...
                description: 'Identify strategic keywords to optimize your website\'s search engine ranking.',
            },
            {
                title: 'On-Page Optimization',
                description: 'Enhance website elements to improve search engine visibility and user experience.',
            },
            {
                title: 'Off-Page Optimization',
                description: 'Build high-quality backlinks and increase your website\'s authority and online presence.',
            },
            {
        ...
        items: [
            {
                ...
                description: 'Gain insights into your target market and identify opportunities for product success.',
            },
            {
                title: 'Product Positioning and Messaging',
                description: 'Craft compelling narratives and positioning for your products to resonate with your audience.',
            },
            {
                title: 'Launch Strategy and Execution',
                description: 'Plan and implement strategic product launches that generate excitement and drive sales.',
            },
            {
                title: 'Product Promotion and Advertising',
                description: 'Develop targeted marketing campaigns to showcase your products and attract customers.',
            },
        ]
    },
    {
